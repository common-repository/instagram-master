...
class instagram_master_admin_addons_table extends WP_List_Table {
	...
	$path = WP_CONTENT_DIR . '/plugins/instagram-master-addons/';
	if ( is_plugin_active( 'instagram-master-addons/instagram-master-addons.php' ) && file_exists($path) ) {
		...
		$instagram_master_addon_get = '<a class="button-primary" href="https://wordpress.techgasp.com/instagram-master/" target="_blank" title="Get all Add-ons" style="float:left;">Get all Add-ons pack for peanuts</a>';
	}
?>
<table class="widefat" cellspacing="0">
	<thead>
		<tr>
			<th colspan="3"><?php echo $instagram_master_addon_get; ?></th>
		</tr>
		<tr>
	...
	<tbody>
		...
		<tr>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-admin-addons-widgets.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			<td style="vertical-align:middle"><h3>Instagram Basic Responsive Embed Widget</h3><p>Light, Fast Loading widget to manually display a single Instagram video or image.<p>Displays Follow, Likes and Comments for max "viralness".</p><p>Navigate to your wordpress widgets page and start using it. <a href="https://wordpress.techgasp.com/instagram-master/" target="_blank"><strong>Demo Link</strong></a>.</p></td>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-yes.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr class="alternate">
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-admin-addons-widgets.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			<td style="vertical-align:middle"><h3>Instagram Advanced Photos Widget</h3><p>This is the "Top of the Line" Instagram Photos Display Widget. The Advanced Instagram Master Photos Widget is a Fast clean html5 that makes <b>NO USE</b> of nasty Javascipt or Ajax.</p><p>Beautiful Full Adaptive Photos display in html5 and CSS gives full control over the number of photo thumbnails to display and their sizes. Each thumbnail displays username and tag labels, perfect for Instagram Photo Comments, Love and Share. <a href="https://wordpress.techgasp.com/instagram-master/" target="_blank"><strong>Demo Link</strong></a>.</p></td>
		...
		<tr class="alternate">
			...
			<td style="vertical-align:middle"><h3>Individual Shortcode</h3><p>instagram Master uses TechGasp Wordpress Framework. The <b>Individual Shortcode</b> allows you to have a different customized instagram buttons in each page or post. Easy to use it can be found in the plugin <b>Individual Shortcodes menu</b> or when you edit a page or a post under the wordpress text editor. Once you have created your shortcode, Just insert the shortcode <b>[instagram-master]</b> anywhere inside that text. <a href="https://wordpress.techgasp.com/instagram-master/" target="_blank"><strong>Demo Link</strong></a>.</p></td>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$instagram_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-admin-addons-shortcodes.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			<td style="vertical-align:middle"><h3>Universal Shortcode</h3><p>instagram Master uses TechGasp Wordpress Framework. The <b>Universal Shortcode</b> allows you to have the same instagram buttons across different pages or posts. Easy to use it can be found right here under the <b>Universal Shortcodes menu</b>. Once you have created your shortcode, Just insert the shortcode <b>[instagram-master-un]</b> anywhere inside the text of your pages or posts. <a href="https://wordpress.techgasp.com/instagram-master/" target="_blank"><strong>Demo Link</strong></a>.</p></td>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$instagram_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr class="alternate">
